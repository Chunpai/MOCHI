...
from dm.utils.dirs import create_dirs
...
def process_config(json_file):
    ...
    config.summary_dir = os.path.join("../dm/experiments",
                                      config.agent,
                                      config.data_name,
                                      config.exp_name,
                                      "summaries/")
    config.checkpoint_dir = os.path.join("../dm/experiments",
                                         config.agent,
                                         config.data_name,
                                         config.exp_name,
                                         "checkpoints/")
    config.out_dir = os.path.join("../dm/experiments",
                                  config.agent,
                                  config.data_name,
                                  config.exp_name,
                                  "out/")
    config.log_dir = os.path.join("../dm/experiments",
                                  config.agent,
                                  config.data_name,
                                  config.exp_name,
                                  "logs/")
